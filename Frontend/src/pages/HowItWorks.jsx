...
const HowItWorks = () => {
  ...
  return (
    <>
      <section className="w-full ml-0 m-0 h-fit px-5 pt-20 flex flex-col min-h-screen py-4 justify-center bg-[#9694FF]">
      <center><div className="w-[400px] h-[300px]">
  <Work />
</div></center>

        <h1
          className={`text-[#FF2929] text-xl font-bold mb-2 min-[480px]:text-2xl md:text-3xl xl:text-3xl 2xl:text-4xl`}
        >
          Discover How AucrionHouse Operates
        </h1>
        <div className="flex flex-col gap-4 my-5">
          {steps.map((element, index) => {
            return (
              <div
                key={index}
                className="bg-white rounded-md p-2 lg:p-5 flex flex-col gap-2 group hover:bg-[#3D3BF3] transition-all duration-300"
              >
                <div className="bg-black text-white p-3 text-xl rounded-full w-fit group-hover:bg-[#FF2929] transition-all duration-300">
                  {element.icon}
                </div>
                <h3
